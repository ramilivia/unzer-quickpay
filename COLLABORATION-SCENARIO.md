...
A senior engineer in your team wants to deploy a new service using AWS Fargate. Another senior engineer in
another team with responsibility for infrastructure wants the service deployed in Kubernetes.
Explain how you would address this situation. What actions would you like to take and why?

# Solution

In order to generate ownership and commitment from all parts, including other members, this type of technical decision should be taken as a team.

The best approach would be to request the two engineers involved to conduct research on the tools and to conduct a knowledge sharing session with the team.
